...
extern void requestIntegrityToken(const char* nonce, JNIEnv *env, jobject main_activity);
...
godot_variant simple_get_data(godot_object *p_instance, void *p_method_data,
    ...
    const char* nonce = "secret nonce secret nonce secret nonce secret nonce secret nonce secret nonce";
    requestIntegrityToken(nonce, env, android_api->godot_android_get_activity());
